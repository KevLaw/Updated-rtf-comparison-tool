...
# Resolve preset paths before Tcl/Tk is touched. Scripted validation supplies
...
say("\nDone.")
quit(status = if (change_generation_failed) 2L else if (isTRUE(result$equivalent)) 0L else 1L)
