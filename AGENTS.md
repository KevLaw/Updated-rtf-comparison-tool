...
Run `Rscript R/run_tests.R` after any change. It must report **364 passed, 0 failed**. In
particular:
...
# run the whole test suite (expect "364 passed"):
...
1. `Rscript R/run_tests.R` → **364 passed, 0 failed** (or more, if you added tests).
